...
const verifyEmail = (email, verificationToken) =>{
   const mail ={
    ...
    padding: 5px 15px; border: 2px solid rgb(245, 146, 86);background-color: white;"><a style="text-decoration: none; font-size:36px; color:orange; line-height: 1.37;" target="_blank" href="https://reg-pet-support.netlify.app/verification/${verificationToken}">verification</a></button>
